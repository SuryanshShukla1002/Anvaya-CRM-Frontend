  ...
  return (
    <div className="flex min-h-screen bg-gray-100">
      ...
      <main className="flex-1 p-8">
        ...
        <div className="bg-gray-300 rounded-xl shadow p-6">
          <h1 className="text-3xl font-bold mb-2">Lead List by Agent</h1>
          {noResult ? (
            <p></p>
          ) : (
            <>
              <p className="text-xl text-purple-800 mb-6 mt-3">
                Sales Agent:{" "}
                {specificAgentLead
                  .slice(0, 1)
          ...
          {noResult && (
            <p className="text-center text-2xl text-red-600 font-semibold mb-4">
